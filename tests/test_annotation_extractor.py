...
class TestExtractReadeckAnnotations(unittest.TestCase):
    ...
    def test_multiple_occurrences_same_id_merge_contexts(self):
        ...
        self.assertEqual(out, [ExtractedAnnotation(id="same", color=None, text="<div><p>onetwo</p></div>")])
...
# This one's wrong :-/
ExtractedAnnotation(id="Q6U8WYZPoHhcmkZGrWguMe", color="green", text="""<div><p>To recap—property-based testing consists of two components:</p><ul><li>Test case </li></ul><ul><li><strong>generation</strong></li></ul><ul><li> using a source of randomness.</li></ul><ul><li>On failing a test, </li></ul><ul><li><strong>shrinking</strong></li></ul><ul><li> it down to a smaller, more understandable size.</li></ul></div>"""),
